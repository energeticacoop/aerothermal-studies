function createRITEmemory() {
  try {
    ...
    const namedRanges = SpreadsheetApp.getActiveSpreadsheet().getSheetByName("Un equipo").getNamedRanges()
    ...
    if (response.getResponseCode() === 200) {
      ...
      const fileName = `${getValue("nombre")} ${getValue("apellidos")} - Memoria RITE.pdf`
